...
GENERAL FEATURES:
- The SDK can be used for developing .NET 6, .NET 5 and .NET Core 3.1 applications (console, WPF, WinForms, ASP.NET Core, service, etc) for Windows
- The SDK can be used for developing .NET 6, .NET 5 and .NET Core 3.1 applications (console, ASP.NET Core, service, etc) for Linux and macOS
- The SDK can be used for developing .NET Framework 4.8-4.0 and 3.5 applications (console, WPF, WinForms, ASP.NET MVC, ASP.NET WebForms, service, etc) for Windows
...
- Windows (Windows 11/10/8.1/8/7; Windows Server 2019/2016/2012/2008; 32-bit and 64-bit) with .NET 6, .NET 5 or .NET Core 3.1
...
- macOS (macOS 12/11/10) with .NET 6 or .NET Core 3.1
- VintaSoft Imaging .NET SDK
